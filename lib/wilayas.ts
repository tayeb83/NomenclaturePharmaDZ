/**
 * Référentiel statique des 58 wilayas d'Algérie (découpage 2021, décret
 * exécutif n° 19-336 — 10 nouvelles wilayas créées à partir des anciennes
 * wilayas du Sud). Sert à afficher la carte complète du pays sur le hub
 * des pharmacies de garde, même pour les wilayas où aucun programme n'est
 * encore importé — la couverture réelle vient de garde_rosters et est
 * croisée par nom (voir lib/garde.ts::buildWilayaHub).
 */
export type WilayaRef = { code: string; name_fr: string; name_ar: string }

export const ALGERIA_WILAYAS: WilayaRef[] = [
