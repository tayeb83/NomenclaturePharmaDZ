...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'ينبغي إعطاء الأولوية لتنظيم المناوبة، التتبع، سلسلة البرودة، تدبير الأدوية منتهية الصلاحية، وصياغة الإجراءات الداخلية بشكل مكتوب وواضح.',
      },
    ],
    content: [
      {
      ...
      {
        type: 'h2',
        title: '4. قائمة تحقق سريعة لصاحب المحل',
        text: 'قبل أي تفتيش أو تحديث تنظيمي، من المفيد التأكد خصوصاً من النقاط التالية:',
      },
      {
        type: 'list',
        items: [
          'توفر **إجراءات العمل القياسية** والوثائق الموقعة.',
          'وجود أدلة تتبع **درجات الحرارة** والصيانة الدورية.',
          'تحيين **جدول المناوبة** وتنظيم التعويض داخل الفريق.',
          'القدرة على تحديد أي دفعة بسرعة عبر **رمز Data Matrix** أو وثائق التتبع.',
        ],
      },
    ],
  },
  {
    ...
    faq: [
      ...
      {
        question: 'هل يمكن للصيدلي المساعد أن يعوض صاحب المحل بشكل نهائي؟',
        answer: 'لا. فهو يعمل تحت مسؤولية صاحب المحل ولا يحل محله نهائياً إلا ضمن إطار تنظيمي خاص وواضح.',
      },
    ],
    content: [
      {
