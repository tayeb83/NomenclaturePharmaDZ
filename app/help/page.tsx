...
const sections: HelpSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        summaryFr: 'Surveillance ciblée des médicaments sensibles.',
        summaryAr: 'متابعة مركزة للأدوية الحساسة.',
        detailsFr: [
          'Regroupe les médicaments critiques pour aider au suivi de continuité de prise en charge.',
          'Facilite l’identification des classes thérapeutiques à surveiller en priorité.',
          'Aide à prioriser les actions de substitution, de commande ou d’information patient.',
        ],
        detailsAr: [
          'تجمع الأدوية الحرجة لمتابعة استمرارية التكفل العلاجي.',
          'تسهل تحديد الفئات العلاجية التي تتطلب مراقبة أولوية.',
          'تساعد في ترتيب أولويات الاستبدال أو الطلب أو توعية المرضى.',
        ],
      },
      {
        href: '/retraits',
